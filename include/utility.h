...
public:
    ...
    // Relocalize
    int relocalizeMode;
    float relocalizeThreadFrequency;
    float relocalizeGlobalTimeout;
    float relocalizeHistoryKeyframeFitnessScore;
    int setMaxCorrespondenceDistance;
    ...
    ParamServer()
    {
        ...
        nh.param<int>("lio_sam/relocalizeMode", relocalizeMode, 0);
        nh.param<float>("lio_sam/relocalizeThreadFrequency", relocalizeThreadFrequency, 1.0);
        nh.param<float>("lio_sam/relocalizeGlobalTimeout", relocalizeGlobalTimeout, 10.0);
        nh.param<float>("lio_sam/relocalizeHistoryKeyframeFitnessScore", relocalizeHistoryKeyframeFitnessScore, 1.0);
        nh.param<int>("lio_sam/setMaxCorrespondenceDistance", setMaxCorrespondenceDistance, 100);
        nh.param<int>("lio_sam/setMaximumIterations", setMaximumIterations, 100);
        nh.param<float>("lio_sam/setTransformationEpsilon", setTransformationEpsilon, 0.000001);
        nh.param<float>("lio_sam/setEuclideanFitnessEpsilon", setEuclideanFitnessEpsilon, 0.000001);
        nh.param<int>("lio_sam/setRANSACIterations", setRANSACIterations, 0);
