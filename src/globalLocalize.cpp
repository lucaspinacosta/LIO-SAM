...
public:
    ...
    mapOptimization()
    {
        ...
        /* START relocalization logic */
        subIniPoseFromRviz = nh.subscribe("lio_sam/relocalization/initialpose", 8, &mapOptimization::initialpose_callback, this);
...
int main(int argc, char** argv)
{
    ...
    std::thread relocalizationThread(&mapOptimization::relocalizationThread, &MO);
