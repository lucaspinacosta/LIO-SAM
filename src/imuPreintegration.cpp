...
public:
    ...
    ros::Subscriber subSetMapToOdom;
    ...
    TransformFusion()
    {
        ...
        subSetMapToOdom = nh.subscribe<geometry_msgs::Transform>("lio_sam/relocalization/set_map_to_odom", 1, &TransformFusion::setMapToOdomHandler, this, ros::TransportHints().tcpNoDelay());
    ...
    void lidarOdometryHandler(const nav_msgs::Odometry::ConstPtr& odomMsg)
    {
        ...
        poseCov.pose.covariance = odomMsg->pose.covariance;
    }
    ...
    void imuOdometryHandler(const nav_msgs::Odometry::ConstPtr& odomMsg)
    {
        ...
        laserOdometry.pose.covariance = poseCov.pose.covariance;
    ...
    void setMapToOdomHandler(const geometry_msgs::Transform::ConstPtr &tfMapToOdom)
    {
        tf::Quaternion quat(tfMapToOdom->rotation.x,
                            tfMapToOdom->rotation.y,
                            tfMapToOdom->rotation.z,
                            tfMapToOdom->rotation.w);

        tf::Vector3 point(tfMapToOdom->translation.x, 
                          tfMapToOdom->translation.y, 
                          tfMapToOdom->translation.z);

        map_to_odom = tf::Transform(quat, point);
    }
};
